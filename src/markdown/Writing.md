...
Afterwards, Dr Rayed and Dr Buhari were impressed at how I scraped the data off blackboard, and they extended my code to create the automatic grader that we all know and love.
...
[A New Paper from OpenAI have created models which are now able to summarize text better than humans!](https://openai.com/blog/learning-to-summarize-with-human-feedback/)
